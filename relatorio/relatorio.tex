...
\begin{document}
	...
	Vale salientar que quartis de índices fracionários foram calculados pela média simples dos dois valores de índices mais próximos.
	\begin{table}[H]
		\centering
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[t]{.49\textwidth}
			\includegraphics[height=.25\textheight, keepaspectratio]{sexo_barra.pdf}
			\caption{Gráfico de barras}
		\end{subfigure}
		\hfill
		\begin{subfigure}[t]{.49\textwidth}
			\includegraphics[height=.25\textheight, keepaspectratio]{sexo_pizza.pdf}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}[t]{.49\textwidth}
			\includegraphics[height=.25\textheight, keepaspectratio]{idade_histograma.pdf}
			\caption{Histograma}
		\end{subfigure}
		\hfill
		\begin{subfigure}[t]{.49\textwidth}
			\includegraphics[height=.25\textheight, keepaspectratio]{idade_boxplot.pdf}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}[t]{.49\textwidth}
			\includegraphics[height=.25\textheight, keepaspectratio]{preco_histograma.pdf}
			\caption{Histograma}
		\end{subfigure}
		\hfill
		\begin{subfigure}[t]{.49\textwidth}
			\includegraphics[height=.25\textheight, keepaspectratio]{preco_boxplot.pdf}
			\caption{\emph{Boxplot}}
		\end{subfigure}
